...
adminLogin();
 ...
 {
    $features = filteration(json_decode($_POST['features']));//decode or convert a JSON object to a PHP object.
    ...
    //euta room ko dherai ota facilities huna sakxa tei vayera foreach loop use garera fid lai bind gareko and execution time also reduced
