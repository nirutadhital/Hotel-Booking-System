...
define('EMAIL',"dhitalnirutaa@gmail.com");
define('NAME', "Hotel Forest View");
...
function alert($type, $msg) {
    $bs_class=($type=="success") ? "alert-success" : "alert-danger";
     //herodoc method of printing statement
     echo <<<alert
...
function uploadSVGImage($image, $folder) {
    $valid_mime =['image/svg+xml'];    //the mime type of svg image is  image/svg+xml
    $img_mime=$image['type'];
    if(!in_array($img_mime, $valid_mime)) {
        return 'inv_img';  //invalid image or format
