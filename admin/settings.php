        ...
        <div class="container-fluid" id="main-content" >
            <div class="row">
                <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                    ...
                    <div class="modal fade" id="general-s" tabindex="-1" data-bs-keyboard="true" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="card shadow border-0 mb-4">
                        <div class="card-body">
                            ...
                            <p class="card-text">No Customers will we allowd to book hotel rooms, when shut down mode is turned on </p>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="contacts-s" tabindex="-1" data-bs-keyboard="true" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal fade" id="team-s" tabindex="-1" data-bs-keyboard="true" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <form  id="team_s_form" >
                            <div class="modal-content">
                                <div class="modal-header">
