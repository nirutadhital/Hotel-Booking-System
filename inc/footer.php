            ...
            <div class="col-lg-4 p-4">
                ...
                <?php
                    if($contact_r['twitter']!='') {
                        echo<<<data
                            <a href="$contact_r[twitter]" target="_blank" class="d-inline-block mb-2 text-dark text-decoration-none">
                ...
                <br>
                <a href="<?php echo $contact_r['fb']?>" target="_blank" class="d-inline-block  text-dark text-decoration-none">
    ...
    <h6 class="text-center bg-dark text-white p-3 m-0 ">Design and Developed By Niruta Dhital</h6>
        ...
        login_form.addEventListener('submit', (e)=>{
            ...
            xhr.onload=function() { 
                if(this.responseText=='inv_email_mob'){
                    ...
                    alert('error', 'Acount Suspended please contact Admin!!');
                }
