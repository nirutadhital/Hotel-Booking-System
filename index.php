    ...
    <div class="container availability-form">
        <div class="row">
            <div class="col-lg-12 bg-white shadow p-4  rounded">
                <h5 class="mb-4">Check Avalilability</h5>
                <form>
                    ...
                    echo <<<data
                        <div class="col-lg-4 col-md-6 my-3">
                            <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
                                ...
                                <h5 class="mb-4">रु $room_data[price] per night</h5>
...
<!-- our facilities -->
  ...
  <div class="swiper swiper-testiminials">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="bg-white p-4 rounded mb-4">
                    <h5>Call Us</h5>
                    <a href="tel: +9779876473821" class="d-inline-block mb-2 text-decoration-none text-dark">
    ...
    <!-- reset password modal javascript code -->
    <?php
...
<!-- swiperjs libarary js link -->
<script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js"></script>
<!-- js for image swipper -->
<script>
