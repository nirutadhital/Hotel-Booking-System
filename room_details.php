        ...
        <div class="col-lg-7 col-md-12 px-4">
            ...
            <div id="roomCarousel" class="carousel slide">
                <div class="carousel-inner">
                    <?php
                    $room_img = ROOMS_IMG_PATH."hbs_thumbnail.png";
            ...
            <div class="card mb-4 border-0 shadow-sm rounded-3">
                <div class="card-body">
                    ...
                    if(!$settings_r['shutdown'])
                    {
                        ...
                        echo<<<book
                            <button  onclick='checkLoginToBook($login,$room_data[id])' class="btn  w-100 mb-1 text-white custom-bg shadow-none">Book Now</button>
                        book;
                    } 
                    ?>
                </div>
